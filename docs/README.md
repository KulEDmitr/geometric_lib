...
В итоге тестирования выяснилось, что ни одна из функций не умеет обрабатывать случаи неккоректных входящих данных, а также неккоректно считает площади с иррациональными входными данными. 
